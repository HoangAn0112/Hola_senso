...
Il faut alors analyser ces données à l'aide d'une AFMH qui permet de prendre en compte cette suite de partition emboitées.

Pour analyser le processus cognitif des sujets, il faut analyser le graph des variables.
